...
const chargeSessionValidation = require('../../validations/chargeSession.validation');
const chargeSessionController = require('../../controllers/chargeSession.controller');
...
router
  ...
  .delete(
    auth('manageSessions'),
    validate(chargeSessionValidation.deleteChargeSession),
    chargeSessionController.deleteChargeSession
  );
