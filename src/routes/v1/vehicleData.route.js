...
const vehicleDataValidation = require('../../validations/vehicleData.validation');
const vehicleDataController = require('../../controllers/vehicleData.controller');
...
router
  .route('/')
  .get(
    auth('getVehicleDataPoints'),
    validate(vehicleDataValidation.getVehicleDataPoints),
    vehicleDataController.getVehicleDataPoints
  );
...
router
  ...
  .get(
    auth('getVehicleDataPoints'),
    validate(vehicleDataValidation.getVehicleDataPoint),
    vehicleDataController.getVehicleDataPoint
  )
  .delete(
    auth('manageVehicleDataPoints'),
    validate(vehicleDataValidation.deleteVehicleDataPoint),
    vehicleDataController.deleteVehicleDataPoint
  );
