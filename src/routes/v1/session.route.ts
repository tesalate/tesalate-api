...
router.route('/').get(auth('getSessions'), validate(sessionValidation.getSessions), sessionController.getSessions);
router.route('/logs').get(auth('getSessions'), validate(sessionValidation.getSessionLogs), sessionController.getSessionLogs);

router
  .route('/aggregate')
  .post(auth('getSessions'), validate(sessionValidation.getSessionAggregation), sessionController.getSessions);

router
  .route('/:sessionId')
  .get(auth('getSessions'), validate(sessionValidation.getSession), sessionController.getSessionAggregateById)
  .delete(auth('manageSessions'), validate(sessionValidation.deleteSession), sessionController.deleteSession);
