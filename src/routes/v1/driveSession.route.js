...
const driveSessionValidation = require('../../validations/driveSession.validation');
const driveSessionController = require('../../controllers/driveSession.controller');

const router = express.Router();

router
  .route('/')
  .get(auth('getSessions'), validate(driveSessionValidation.getDriveSessions), driveSessionController.getDriveSessions);

router
  .route('/:driveSessionId')
  .get(auth('getSessions'), validate(driveSessionValidation.getDriveSession), driveSessionController.getDriveSession)
  .delete(
    auth('manageSessions'),
    validate(driveSessionValidation.deleteDriveSession),
    driveSessionController.deleteDriveSession
  );
