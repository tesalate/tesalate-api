...
const vehicleData = new Schema<IVehicleData>(
  {
    id: {
      type: Number,
    },
...
interface VehicleDataModel extends Model<IVehicleData>, IPaginator, IToJSON {}

/**
 * @typedef VehicleData
 */
const VehicleData = mongoose.model<IVehicleData, VehicleDataModel>('VehicleData', vehicleData, 'vehicledata');
