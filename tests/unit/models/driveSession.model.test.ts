...
import { IDriveSession } from '../../../src/models/driveSession.model';
import { DriveSession } from '../../../src/models';
import { driveSessionForVehicleOneForAdmin } from '../../fixtures/driveSession.fixture';

let newDriveSession: AnyKeys<IDriveSession> & AnyObject;
