...
import { ChargeSession } from '../../../src/models';
import { IChargeSession } from '../../../src/models/chargeSession.model';
import { chargeSessionForVehicleOneForAdmin } from '../../fixtures/chargeSession.fixture';

let newChargeSession: AnyKeys<IChargeSession> & AnyObject;
