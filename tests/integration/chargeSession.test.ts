...
} from '../fixtures/chargeSession.fixture';
...
import { VehicleData, ChargeSession } from '../../src/models';
import { insertFlags, infoFlag, warningFlag, errorFlag } from '../fixtures/flag.fixture';
...
describe('ChargeSession routes', () => {
  describe('GET /v1/charge-sessions', () => {
    ...
    test('should return 200 error if an admin tries to get all their charge sessions', async () => {
      await insertUsers([admin, userOne]);
    ...
    test('should return 200 error if regular user tries to get all of their charge sessions', async () => {
  ...
  describe('GET /v1/charge-sessions/:chargeSessionId', () => {
    test('should return 200 and the charge session object if data is ok', async () => {
      ...
      const dbVehicleData = await VehicleData.find({ charge_session_id: _id.toHexString() }).lean();
